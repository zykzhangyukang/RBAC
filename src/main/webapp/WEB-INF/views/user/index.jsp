...
<script>
    ...
    function build_user_table(data) {
        ...
        $.each(users, function (index, item) {
            ...
            var userAgeTd = $("<td></td>").append(item.age);
            var userEmailTd = $("<td></td>").append(item.email);
            var userPhoneTd = $("<td></td>").append(item.phonenumber);
            var userLoginId = $("<td></td>").append(item.loginId);
            ...
            var assBtn=  $("<button></button>").addClass("btn btn-default assBtn btn-sm glyphicon glyphicon-wrench").append("分配");
            var assBtnTd = $("<td></td>").append(assBtn);
    ...
    $("table").delegate(".delete-btn", "click", function () {
        ...
        var url = "${APP_PATH}/user/deleteUser";
